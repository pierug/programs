...
#include "../../EasyHospitalv2/calltab.h"
...
struct qt_meta_stringdata_CallTab_t {
    QByteArrayData data[1];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CallTab_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CallTab_t qt_meta_stringdata_CallTab = {
    {
QT_MOC_LITERAL(0, 0, 7) // "CallTab"
...
const QMetaObject CallTab::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CallTab.data,
      qt_meta_data_CallTab,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CallTab::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CallTab.stringdata0))
